...
def main() -> None:
    ...
    engine.dispose(); DB_PATH.unlink(missing_ok=True); print("Populated SQLite upgrade 0020 -> 0037 succeeded, preserved existing data, and backfilled Shopping purchase satisfaction provenance.")
