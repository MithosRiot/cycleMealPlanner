...
def upgrade() -> None:
    with op.batch_alter_table("shopping_list_items") as batch_op:
        ...
        batch_op.create_foreign_key(
            "fk_shopping_item_storage_location",
            "inventory_locations",
            ["storage_location_id"],
            ["id"],
            ondelete="RESTRICT",
        ...
        batch_op.create_foreign_key(
            "fk_shopping_item_inventory_lot",
            "inventory_lots",
            ["inventory_lot_id"],
            ["id"],
            ondelete="RESTRICT",
...
def downgrade() -> None:
    with op.batch_alter_table("shopping_list_items") as batch_op:
        ...
        batch_op.drop_constraint("fk_shopping_item_inventory_lot", type_="foreignkey")
        batch_op.drop_constraint("fk_shopping_item_storage_location", type_="foreignkey")
        batch_op.drop_constraint("fk_shopping_item_actual_unit", type_="foreignkey")
