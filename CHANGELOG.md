...
- Shopping partial-purchase and Ingredient-substitution workflows with append-only purchase provenance, explicit actual-versus-satisfied quantities, unresolved-demand tracking, regeneration-safe purchase history, idempotent exactly-once Inventory intake, and validation/Dashboard shortage reconciliation.
