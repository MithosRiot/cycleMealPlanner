...
export type CookingStepInput = { title: string; instructions: string | null; prep_group_id: number | null; sort_order: number; timers: CookingTimerInput[]; recipe_equipment_ids: number[]; temperatures: CookingTemperatureInput[] }
