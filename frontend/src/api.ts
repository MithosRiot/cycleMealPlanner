...
export const scaleRecipe = (id: number, requestedServings: string, unitOverrides: Record<number, string> = {}, substitutionOverrides: Record<number, number> = {}): Promise<RecipeScaleResponse> => jsonRequest(`/api/recipes/${id}/scale`, { method: 'POST', body: JSON.stringify({ requested_servings: requestedServings, unit_overrides: unitOverrides, substitution_overrides: substitutionOverrides }) })
