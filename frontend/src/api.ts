...
export type RecipeIngredientInput = { ingredient_id: number; quantity: string; unit_id: number; display_text: string | null; preparation: string | null; optional: boolean; scaling_mode: 'LINEAR' | 'FIXED' | 'ROUND_UP' | 'MANUAL'; required_state: string; sort_order: number; notes: string | null }
export type RecipeIngredient = RecipeIngredientInput & { id: number; recipe_id: number }
export type RecipeInput = { name: string; description: string | null; base_servings: string; serving_unit: string; yield_quantity: string | null; yield_unit_id: number | null; prep_time_minutes: number | null; cook_time_minutes: number | null; notes: string | null; favorite: boolean; meal_types: string[]; tag_ids: number[]; ingredients: RecipeIngredientInput[]; active?: boolean }
export type Recipe = { id: number; household_id: number; name: string; description: string | null; base_servings: string; serving_unit: string; yield_quantity: string | null; yield_unit_id: number | null; prep_time_minutes: number | null; cook_time_minutes: number | null; notes: string | null; favorite: boolean; active: boolean; meal_types: string[]; tags: Tag[]; ingredients: RecipeIngredient[] }
export type ScaledRecipeIngredient = { recipe_ingredient_id: number; ingredient_id: number; quantity: string; unit_id: number; unit_code: string; scaling_mode: string; manual_review: boolean }
